...
.extern __bss_start
.extern __bss_end
.extern __ts_hw_irq_handler
.extern __ts_hw_swi_handler
.extern irqBlock
.extern main
	.section .init
	.globl _start
...
swi_handler:        .word __ts_hw_swi_handler
prefetch_handler:   .word prefetch_abort
data_handler:       .word data_abort
unused_handler:     .word unused
irq_handler:        .word __ts_hw_irq_handler
fiq_handler:        .word fiq

reset:
  ;@
  ;@	In the reset handler, we need to copy our interrupt vector table to 0x0000, its currently at 0x8000
  ;@ GPU core loads our image at 0x0000:0x8000
  ;@ Our goal is copy vector table to 0x0000:0x0000
  ;@
  ...
  ;@  copy vectors from 0x8000 to 0x0000
  ;@
  ...
  ;@
  ;@ variables with initialized data in .data section are already loaded at RAM
  ;@ by loading image at the exact RAM location
  ;@
zero_loop:
  cmp 	r0,r1
  it		lt
